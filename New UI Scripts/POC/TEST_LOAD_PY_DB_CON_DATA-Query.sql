...
INSERT INTO TEST_PY_DB_CON (
  ...
  SERVICECODE, STATUSFLAG, BILLED, ISCONFIRMED, CO_TO, CO_SP, CO_OP, CO_FP
) 
SELECT 
  * 
FROM 
    ...
    FROM 
      (
        SELECT 
          ...
          CASE WHEN V2."StatusFlag" IN('R', 'D') THEN 'R' WHEN V2."StatusFlag" IN ('N') THEN 'N' ELSE 'U' END AS "ConflictStatusFlag" 
        FROM 
          CONFLICTVISITMAPS AS V1 
          INNER JOIN CONFLICTS AS V2 ON V2."CONFLICTID" = V1."CONFLICTID" 
        WHERE 
      ...
      AND a."GroupID" = b."GroupID" 
    GROUP BY 
      a.CRDATEUNIQUE, a."ServiceCode", a."StatusFlag", a."Billed", a."IsConfirmed"
    UNION ALL 
    SELECT 
      '${payerId}' AS PAYERID, 
      a."CRDATEUNIQUE" AS "CRDATEUNIQUE", 
