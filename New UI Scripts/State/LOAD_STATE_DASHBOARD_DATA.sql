...
AS '
	...
	var SQL4 = `INSERT INTO CONFLICTREPORT_SANDBOX.PUBLIC.STATE_DASHBOARD_CON_TYPE (PAYERSTATE, PAYERID, PROVIDERID, CRDATEUNIQUE, STATUSFLAG, COSTTYPE, VISITTYPE, COUNTY, SERVICECODE, TO_TO, TO_SP, TO_OP, TO_FP, TD_TO, TD_SP, TD_OP, TD_FP, IN_TO, IN_SP, IN_OP, IN_FP)
	SELECT
